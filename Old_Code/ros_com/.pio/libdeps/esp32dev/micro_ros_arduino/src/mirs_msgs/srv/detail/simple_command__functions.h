...
#ifndef MIRS_MSGS__SRV__DETAIL__SIMPLE_COMMAND__FUNCTIONS_H_
#define MIRS_MSGS__SRV__DETAIL__SIMPLE_COMMAND__FUNCTIONS_H_
...
/// Initialize srv/SimpleCommand message.
/**
...
/// Finalize srv/SimpleCommand message.
/**
...
/// Create srv/SimpleCommand message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mirs_msgs__srv__SimpleCommand_Request__init().
...
/// Destroy srv/SimpleCommand message.
/**
 * It calls
 * mirs_msgs__srv__SimpleCommand_Request__fini()
...
/// Check for srv/SimpleCommand message equality.
/**
...
/// Copy a srv/SimpleCommand message.
/**
...
/// Initialize array of srv/SimpleCommand messages.
/**
...
/// Finalize array of srv/SimpleCommand messages.
/**
 * It calls
 * mirs_msgs__srv__SimpleCommand_Request__fini()
...
/// Create array of srv/SimpleCommand messages.
/**
 * It allocates the memory for the array and calls
 * mirs_msgs__srv__SimpleCommand_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SimpleCommand messages.
/**
 * It calls
 * mirs_msgs__srv__SimpleCommand_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SimpleCommand message array equality.
/**
...
/// Copy an array of srv/SimpleCommand messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mirs_msgs__srv__SimpleCommand_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mirs_msgs
...
/**
 * It calls
 * mirs_msgs__srv__SimpleCommand_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_mirs_msgs
...
/**
 * It allocates the memory for the array and calls
 * mirs_msgs__srv__SimpleCommand_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mirs_msgs
...
/**
 * It calls
 * mirs_msgs__srv__SimpleCommand_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MIRS_MSGS__SRV__DETAIL__SIMPLE_COMMAND__FUNCTIONS_H_
