...
#ifndef MIRS_MSGS__SRV__DETAIL__SIMPLE_COMMAND__TYPE_SUPPORT_H_
#define MIRS_MSGS__SRV__DETAIL__SIMPLE_COMMAND__TYPE_SUPPORT_H_
...
#endif  // MIRS_MSGS__SRV__DETAIL__SIMPLE_COMMAND__TYPE_SUPPORT_H_
