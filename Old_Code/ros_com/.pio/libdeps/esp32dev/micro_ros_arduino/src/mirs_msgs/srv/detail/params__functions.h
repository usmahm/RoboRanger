...
#ifndef MIRS_MSGS__SRV__DETAIL__PARAMS__FUNCTIONS_H_
#define MIRS_MSGS__SRV__DETAIL__PARAMS__FUNCTIONS_H_
 ...
 * calls
 * mirs_msgs__srv__Params_Request__init().
...
/**
 * It calls
 * mirs_msgs__srv__Params_Request__fini()
 ...
 * mirs_msgs__srv__Params_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * mirs_msgs__srv__Params_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mirs_msgs__srv__Params_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mirs_msgs
...
/**
 * It calls
 * mirs_msgs__srv__Params_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_mirs_msgs
...
/**
 * It allocates the memory for the array and calls
 * mirs_msgs__srv__Params_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mirs_msgs
...
/**
 * It calls
 * mirs_msgs__srv__Params_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MIRS_MSGS__SRV__DETAIL__PARAMS__FUNCTIONS_H_
